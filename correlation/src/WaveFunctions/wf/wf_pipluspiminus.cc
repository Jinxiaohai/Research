#ifndef __CWAVEFUNCTION_WF_PIPLUSPIMINUS_CC
#define __CWAVEFUNCTION_WF_PIPLUSPIMINUS_CC

CWaveFunction_pipluspiminus::CWaveFunction_pipluspiminus(char *parsfilename){
  int iq,ichannel,*I;
  double q;
  ...
  printf("pipluspiminus wf initialized\n");
}

double CWaveFunction_pipluspiminus::CalcPsiSquared(int iq,double r,
						  double ctheta){
