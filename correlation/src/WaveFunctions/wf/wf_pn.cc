...
CWaveFunction_pn::CWaveFunction_pn(char *parsfilename) : CWaveFunction() {
  int iq,ichannel;
  double q;
  ...
  read_phaseshifts();
  printf("reading phaseshifts finished\n");
...
double CWaveFunction_pn::CalcPsiSquared(int iq,double r,double ctheta){
...
void CWaveFunction_pn::read_phaseshifts(){
