#ifndef __CWAVEFUNCTION_WF_KPLUSPIMINUS_CC
#define __CWAVEFUNCTION_WF_KPLUSPIMINUS_CC

CWaveFunction_kpluspiminus::CWaveFunction_kpluspiminus(char *parsfilename) : CWaveFunction() {
  int iq,ichannel;
  double q;
...
double CWaveFunction_kpluspiminus::CalcPsiSquared(int iq,double r,double ctheta){
...
void CWaveFunction_kpluspiminus::get_phaseshifts_kpluspiminus(){
