#ifndef __CWAVEFUNCTION_WF_PLAMBDA_CC
#define __CWAVEFUNCTION_WF_PLAMBDA_CC

CWaveFunction_plambda::CWaveFunction_plambda(char *parsfilename) : CWaveFunction() {
  int iq,ichannel;
  double q;
...
double CWaveFunction_plambda::CalcPsiSquared(int iq,double r,double ctheta){
...
void CWaveFunction_plambda::get_phaseshifts(){
