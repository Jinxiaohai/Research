...
CCF2S_Minuit_GX1D::CCF2S_Minuit_GX1D(CSourceCalc *scset,CCHArray *cexpset,
  ...
  pars[0].Set("lambdaG",parameter::getD(sourcecalc->spars,"lambdaG",0.3),1.0,0,0.0);
  pars[1].Set("R",parameter::getD(sourcecalc->spars,"R",5),1.0,0.0,20.0);
  pars[2].Set("lambdaX",parameter::getD(sourcecalc->spars,"lambdaX",0.3),1.0,0.0,20.0);
