#ifndef __CWAVEFINCTION_WF_PIPLUSPIPLUS_CC
#define __CWAVEFINCTION_WF_PIPLUSPIPLUS_CC

CWaveFunction_pipluspiplus::CWaveFunction_pipluspiplus(char *parsfilename){
  int iq,ichannel;
  double q;
  int *I;
...
double CWaveFunction_pipluspiplus::CalcPsiSquared(int iq,double r,
						 double ctheta){
