#ifndef __CWAVEFUNCTION_WF_NN_CC
#define __CWAVEFUNCTION_WF_NN_CC

CWaveFunction_nn::CWaveFunction_nn(char *parsfilename) : CWaveFunction() {
  int iq,ichannel;
  double q;
...
double CWaveFunction_nn::CalcPsiSquared(int iq,double r,double ctheta){
...
void CWaveFunction_nn::read_phaseshifts(){
