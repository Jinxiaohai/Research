...
#define __CWAVEFUNCTION_WF_LAMBDALAMBDA_CC
 ...
 CWaveFunction_lambdalambda::CWaveFunction_lambdalambda(char *parsfilename){
  int iq,ichannel;
  double q,q0;
...
double CWaveFunction_lambdalambda::CalcPsiSquared(int iq,double r,double ctheta){
...
void CWaveFunction_lambdalambda::GetPhaseshifts(){
  double q,q0;
