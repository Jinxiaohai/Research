...
void eventDisplay(char *outputFile = "evolution_out.root")
{
  ...
  while (myFileInitialInfo)
    {
      ...
      myFileInitialInfo >> evtnumber >> iterindex >> nlist
                        >> nbaryons >> nmesons >> nparticles >> nparticleszpc;
      ...
      for (int i=0;i<nlist;i++)
        {
          ...
          myFileInitialInfo >> partid >> pvec[0] >> pvec[1] >> pvec[2]
                            >> mass >> spacetime[0] >> spacetime[1] >> spacetime[2] >> spacetime[3];
