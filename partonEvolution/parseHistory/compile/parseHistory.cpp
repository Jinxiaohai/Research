  ...
  int main(int argc, char *argv[])
{
  ...
  // char *initialInfoFile = "../parton-initial-afterPropagation.dat";
  ...
  myFileInitialInfo.open("../parton-initial-afterPropagation.dat");

  //Read parton evolution from file
  ifstream myFileEvolInfo;
  myFileEvolInfo.open("../parton-collisionsHistory.dat");
      ...
      for (int i=0;i<nlist;i++)
        {
          ...
          myFileInitialInfo >> partid >> pvec[0] >> pvec[1] >> pvec[2] >> mass
  ...
  writeHistograms("./evolution_out.root");
  //draw();
  return 0;
}
