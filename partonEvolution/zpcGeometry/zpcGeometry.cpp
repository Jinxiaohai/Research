  ...
  while (inputData)
    {
      ...
      while (input)
        {
          input >> iaevt >> miss >> partonNum >> bimpact >> nelp >> ninp >> nelt >> nint;
          if(!input) break;
