...
// Fri Jun 23 16:29:14 2017 by ROOT version 6.06/08
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Event_NINT;
   Int_t           ID[484];   //[multi]
   Float_t         Px[484];   //[multi]
   Float_t         Py[484];   //[multi]
   Float_t         Pz[484];   //[multi]
   Float_t         Mass[484];   //[multi]
   Float_t         X[484];   //[multi]
   Float_t         Y[484];   //[multi]
   Float_t         Z[484];   //[multi]
   Float_t         Time[484];   //[multi]
