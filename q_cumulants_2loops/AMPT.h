...
// Wed Apr 26 10:55:16 2017 by ROOT version 5.34/24
...
public :
   ...
   Int_t           Event_NINT;
   Int_t           ID[8884];   //[multi]
   Float_t         Px[8884];   //[multi]
   Float_t         Py[8884];   //[multi]
   Float_t         Pz[8884];   //[multi]
   Float_t         Mass[8884];   //[multi]
   Float_t         X[8884];   //[multi]
   Float_t         Y[8884];   //[multi]
   Float_t         Z[8884];   //[multi]
   Float_t         Time[8884];   //[multi]
